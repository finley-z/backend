...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		/**
		 * Get the position of an element relative to the top left of the pagination
		 */
		offset: function (el) {
			return $(el).offset();
		},
...
Legend.prototype = {
	...
	scroll: function (scrollBy, animation) {
		...
		// When resizing while looking at the last pagination

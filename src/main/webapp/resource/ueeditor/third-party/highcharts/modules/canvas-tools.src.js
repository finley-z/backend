...
(function(){
	// canvg(target, s)
	// empty parameters: replace all 'svg' elements on pagination with 'canvas' elements
...
(function (Highcharts) { // encapsulate
	...
	extend(CanVGRenderer.prototype, {
		...
		setContainer: function (container, chartWidth, chartHeight) {
			...
			// the container (and as direct childs to the div specified in the html pagination)

...
public class AntZipUtils {
	...
	public static void zip(File[] srcFiles, File destFile, FileFilter filter,
			String encoding) {
		try {
	...
	public static void zip(File[] srcFiles, OutputStream os, FileFilter filter,
			String encoding) {
		Assert.notEmpty(srcFiles);
